...
def _machine_learning_autograd(circuit):
	return NotImplemented


def _machine_learning_tf(circuit):
	return NotImplemented


def _machine_learning_torch(circuit):
	return NotImplemented
...
def benchmark_machine_learning(hyperparams={}, num_repeats=1):
	...
	for _ in range(num_repeats):
		...
		if interface == 'autograd':
			_machine_learning_autograd(circuit)

		elif interface == 'tf':
			_machine_learning_tf(circuit)

		elif interface == 'torch':
			_machine_learning_torch(circuit)
